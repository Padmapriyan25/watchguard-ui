  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
      ...
      <div className="mb-6 pb-6 border-b border-gray-100">
        ...
        <p className="text-3xl font-bold text-[#CC0000]">$4,280</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-between items-baseline">
          ...
          <p className="text-xs text-slate-400">3/1/2025</p>
        </div>
      </div>
      
      <div className="mb-6">
        <p className="text-sm text-slate-500 mb-1">Next Invoice Due</p>
        <p className="text-sm font-bold text-slate-800">May 1, 2025</p>
      </div>
